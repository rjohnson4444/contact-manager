...
RSpec.describe PhoneNumbersController, type: :controller do
  ...
  let(:invalid_attributes) {
    { number: nil, contact_id: 1, contact_type: nil }
  }
  ...
  describe "DELETE #destroy" do
    let(:fred) { Person.create(first_name: "Fred", last_name: "Jackson") }
    let(:valid_attributes) { {number: '333-4444', contact_id: fred.id, contact_type: 'Person'} }
    ...
    it "redirects to the phone_numbers list" do
      phone_number = PhoneNumber.create! valid_attributes
      delete :destroy, {:id => phone_number.to_param}, valid_session
      expect(response).to redirect_to(fred)
    end
  end
end
